...
router.post('/create-transaction', async (req, res) => {
    try {
      ...
      const transaction = await ( new transbank.Transaction()).create(
        ...
        /* Build HTML form 
          using JavaScript to submit the form programmatically 
          right after it's constructed
          this way User avoid submit button
          redirecting automatically to payment URL
        */
        const form = `
